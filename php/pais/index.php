...
<div class="box-header">
    ...
    <div class="pull-right box-tools">
    	<button class="btn btn-info btn-sm" id="nuevo"  data-toggle="tooltip" title="Nuevo País"><i class="glyphicon glyphicon-plus" aria-hidden="true"></i></button> 
...
<div class="box-body">
	...
	<li><a  class = "reporte" href="../pais/exPDF.php" target="_blank"><i class="fa fa-building"></i> Reporte en PDF</a></li>
