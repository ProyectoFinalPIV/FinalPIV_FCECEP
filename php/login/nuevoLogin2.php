<div id="seccion-login2" class="show">
<!--validacion
<style type="text/css">
    ...
    <div class="box-body">
        ...
        <div class="panel-group"><div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form"  id="flogin2">
                    ...
                    <div class="form-group">        
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" id="grabar2" class="btn btn-primary" data-toggle="tooltip" title="Grabar Persona">Grabar Persona</button>
